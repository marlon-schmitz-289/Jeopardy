...
public partial class MainWindow : Window
{
    ...
    private void ReadQuestions()
    {
        ...
        while (!sr.EndOfStream)
        {
            ...
            _questions.Add(new Question(line[0], line[1],
                File.Exists(line[0]) ? line[0].Split('.').Last() is "mp3" or "wav" ? QuestionType.Audio : QuestionType.Image : QuestionType.Text));
        }
    ...
    private void SaveUsers()
    {
        ...
        using var sw = new StreamWriter(_USERNAMES_PATH, append: false);
    ...
    private void SaveCategories()
    {
        ...
        using var sw = new StreamWriter(_CATEGORIES_PATH, append: false);
    ...
    private void SaveQuestions()
    {
        ...
        using var sw = new StreamWriter(_QUESTIONS_PATH, append: false);
